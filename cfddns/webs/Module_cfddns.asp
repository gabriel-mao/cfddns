    ...
    <body>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td bgcolor="#4D595D" colspan="3" valign="top">
                                                            ...
                                                            <div class="SimpleNote" id="head_illustrate"><i></i><em>CloudFlare DDNS</em>是基于 CloudFlare API 实现的个人 DDNS 工具。<a href='https://github.com/gabriel-mao/cfddns.git' target='_blank'><i>&nbsp;&nbsp;<u>点击查看插件详情</u></i></a></div>
                                                            <table style="margin:20px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr id="zoneid_tr">
                                                                        <th>Zone Id</th>
                                                                        <td> <input type="text" id="cfddns_zoneid" value="<% dbus_get_def("cfddns_zoneid", ""); %>" class="input_ss_table"></td>
                                                                    </tr>
                                                                    <tr id="interval_tr">
                                                                        <th>检查周期</th>
                                                                    ...
                                                                    <tr id="name_tr">
                                                                        <th>域名</th>
                                                                        <td> 
                                                                            <input type="text" style="width: 80%;" id="cfddns_name" value="<% dbus_get_def("cfddns_name", ""); %>" class="input_ss_table">
                                                                        </td>
                                                                    </tr>
                                                                    <tr id="dns_tr">
        ...
        <script>
            $(function () {
                ...
                update_visibility();
                var posting = false;
            	var inputs = ['email', 'key', 'zoneid', 'name', 'interval', 'dns', 'curl', 'ttl'];
            ...
            function update_visibility(){
                if (document.getElementById('switch').checked) {
                    ...
                    document.getElementById("zoneid_tr").style.display = "";
                    ...
                    document.getElementById("zoneid_tr").style.display = "none";
